      ...
      >
        ...
        >
          <div style={{ borderRadius: "10px" }}>
            <img src="instagram.png" style={{ borderRadius: "10px", width: "100%", height: "60vh" }} />
          </div>
          <div style={{
            width: "100%", display: "flex", marginTop: "3%", height: "10vh", textAlign: "center", alignItems: "center", justifyContent: "center"
          }}>
            < div style={{ fontSize: "14px", background: "#f50057", textAlign: "center", width: "170px", height: "40px", paddingTop: "9px", borderRadius: "10px", color: "white" }}>Connect to Instagram</div>
          </div>
        </div>
      </div >
